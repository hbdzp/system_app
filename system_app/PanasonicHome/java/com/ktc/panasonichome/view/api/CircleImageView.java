...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderColor = a.getColor(R.styleable.CircleImageView_border_color, Color.BLACK);
        this.mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_border_overlay, DEFAULT_BORDER_OVERLAY);
        this.mRadiu = a.getDimensionPixelSize(R.styleable.CircleImageView_radiu, DEFAULT_RADIU);
        a.recycle();
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (getDrawable() != null) {
            ...
            } else if (this.mRadiu > 0 && this.mRect != null) {
                canvas.drawRoundRect(this.mRect, (float) this.mRadiu, (float) this.mRadiu, this.mBitmapPaint);
            }
        }
    }
