...
public class BasePostItem_Smail extends BaseItem {
    public BasePostItem_Smail(Context context, MyFocusFrame focusView) {
        super(context, focusView);
    }

    public void initView() {
        setItemWidth(ScreenParams.getInstence(this.mContext).getResolutionValue(220));
        setItemHeight(ScreenParams.getInstence(this.mContext).getResolutionValue(220));
        ...
        LayoutParams title_p = new LayoutParams(ScreenParams.getInstence(this.mContext).getResolutionValue(180), -2);
        title_p.gravity = 81;
        title_p.bottomMargin = ScreenParams.getInstence(this.mContext).getResolutionValue(10);
