...
import com.mstar.tvsetting.switchinputsource.PanasonicToast;
...
public class TVCounterActivity extends Activity {
    ...
    private class RootReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action
                ...
                if(remainSeconds > 60){
                	linearLayoutPopupOffTime.setVisibility(View.GONE);
                	textViewOffTimeSecond.setText("--");
                }else{
                	linearLayoutPopupOffTime.setVisibility(View.VISIBLE);
                textViewOffTimeSecond.setText("" + remainSeconds);
					  if(remainSeconds==1){
                    	context.sendBroadcast(new Intent("com.mstar.tvsetting.hotkey.DisableNoSignal"));
                    }
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ktc nathan.liao 20140903 for count down error when on key cancel start 
        linearLayoutPopupOffTime.setVisibility(View.GONE);
        //ktc nathan.liao 20140903 for count down error when on key cancel end 
    ...
    public void onUserInteraction() {
        if (linearLayoutPopupOffTime.getVisibility() == View.VISIBLE) {
            ...
            PanasonicToast.makeText(this.getApplicationContext(),R.string.str_timer_cancel)
                    .show();
        }
