...
public class Utility {
     ...
     * TvSystem
     *
     * @see TvCommonManager#TV_SYSTEM_DVBT
     * @see TvCommonManager#TV_SYSTEM_DVBC
     * @see TvCommonManager#TV_SYSTEM_DVBS
     * @see TvCommonManager#TV_SYSTEM_DVBT2
     * @see TvCommonManager#TV_SYSTEM_DVBS2
     * @see TvCommonManager#TV_SYSTEM_DTMB
     * @see TvCommonManager#TV_SYSTEM_ATSC
     * @see TvCommonManager#TV_SYSTEM_ISDB
     */
    ...
    private static Context getContext() {
        if (null == sContext) {
            sContext = KtcApplication.getContext();
        }
        return sContext;
    }
     ...
     * @see {@link TvChannelManager#TV_ROUTE_NONE}
     * @see {@link TvChannelManager#TV_ROUTE_DVBT}
     * @see {@link TvChannelManager#TV_ROUTE_DVBC}
     * @see {@link TvChannelManager#TV_ROUTE_DVBS}
     * @see {@link TvChannelManager#TV_ROUTE_ATSC}
     * @see {@link TvChannelManager#TV_ROUTE_ISDB}
     * @see {@link TvChannelManager#TV_ROUTE_DVBT2}
     * @see {@link TvChannelManager#TV_ROUTE_DVBS2}
     * @see {@link TvChannelManager#TV_ROUTE_DTMB}
     * @see {@link TvChannelManager#DTV_ANTENNA_TYPE_NONE}
     * @see {@link TvChannelManager#DTV_ANTENNA_TYPE_AIR}
     * @see {@link TvChannelManager#DTV_ANTENNA_TYPE_CABLE}
     */
            ...
            for (int index = 0; index < viewGroup.getChildCount(); ++index) {
                ...
                if (null != view) {
                    if (true == view.isFocusable()) {
                        ...
                        viewNearest = view.focusSearch(View.FOCUS_LEFT);
                        if (null != viewNearest) {
                            view.setNextFocusUpId(viewNearest.getId());
                        }
                        ////viewNearest = view.focusSearch(View.FOCUS_FORWARD);
                        viewNearest = view.focusSearch(View.FOCUS_RIGHT);
                        if (null != viewNearest) {
