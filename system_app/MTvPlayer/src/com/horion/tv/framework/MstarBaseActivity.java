...
public class MstarBaseActivity extends Activity implements MstarBaseInterface {
    ...
    public void resetTimer() {
        if (timerHander.hasMessages(delayMessage)) {
            ...
            Log.d("Maxs53","mDelayMillis = " + mDelayMillis);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (SwitchPageHelper.goToSource(this,keyCode) == true){
            return true;
        }else if(SwitchPageHelper.goToProgrameListInfo(this, keyCode) == true){
            return true;
        }else if (SwitchPageHelper.goToChannelChange(this,keyCode, false) == true){
            return true;
    ...
    public static class MstarUIActivity extends BaseUIActivity {
