...
////import com.ktc.framework.ktcsdk.properties.KtcSystemProperties;
import com.ktc.ui.blurbg.BlurringView.OnBlurFinishListener;
import com.horion.tv.R;

public class BlurBgLayout extends FrameLayout implements OnBlurFinishListener {
    ////private static /* synthetic */ int[] -com_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues;
    ...
    ////private static /* synthetic */ int[] -getcom_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues() {
    private static /* synthetic */ int[] getPAGETYPESwitchsValues() {
        /////if (-com_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues != null) {
        /////    return -com_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues;
        /////}
        ...
        /////-com_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues = iArr;
    ...
    private void initView() {
        ////this.pe = KtcSystemProperties.getProperty("ro.build.PE");
        this.pe = "PE";
        if (!TextUtils.isEmpty(this.pe)) {
            ...
            this.bgViewP = new LayoutParams(-2, -2);
    ...
    public void setPageType(PAGETYPE pagetype) {
        if (TextUtils.isEmpty(this.pe)) {
            ...
            if (this.version >= 19) {
                ////switch (-getcom_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues()[pagetype.ordinal()]) {
        ...
        Log.d("Maxs","#########BlurBgLayout:setPageType = " + getPAGETYPESwitchsValues()[pagetype.ordinal()]);
        ////switch (-getcom_ktcworth_ui_blurbg_BlurBgLayout$PAGETYPESwitchesValues()[pagetype.ordinal()]) {
        switch (getPAGETYPESwitchsValues()[pagetype.ordinal()]) {
            case 1:
