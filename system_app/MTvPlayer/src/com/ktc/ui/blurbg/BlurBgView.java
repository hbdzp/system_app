...
public class BlurBgView extends FrameLayout {
    ...
    public BlurBgView(Context context) {
        ...
        this.bgViewW = KtcScreenParams.getInstence(this.mContext).getResolutionValue(1920);
        this.bgViewH = KtcScreenParams.getInstence(this.mContext).getResolutionValue(1080);
